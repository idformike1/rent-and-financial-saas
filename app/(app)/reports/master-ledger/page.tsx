    ...
    <div className="py-8 px-4 sm:px-6 h-full flex flex-col max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-6 border-b border-border pb-10">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button onClick={handlePDFExport} className="bg-[var(--primary)] text-white font-black px-6 py-3 rounded-xl shadow-[4px_4px_0px_0px_rgba(67,56,202,0.2)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all flex items-center uppercase tracking-widest text-[10px]">
