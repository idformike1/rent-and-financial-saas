    ...
    <div className="space-y-12 pb-20">
      ...
      <div className="border-b-8 border-slate-900 pb-10">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <h1 className="text-6xl font-black italic tracking-tighter text-slate-900 uppercase">Mass Ingestion Engine</h1>
        </div>
        <div className="flex items-center space-x-6">
          ...
          <p className="text-slate-900 font-black text-[10px] uppercase tracking-widest bg-yellow-400 px-3 py-1 italic">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div 
          ...
          className={`relative group bg-slate-50 border-8 border-dashed transition-all duration-300 rounded-[3rem] p-16 flex flex-col items-center justify-center text-center ${
            file ? 'border-indigo-600 bg-indigo-50' : 'border-slate-300 hover:border-slate-900'
          }`}
        >
          {file ? (
            <div className="space-y-6 animate-in zoom-in-90 fill-mode-forwards duration-500">
               <div className="bg-indigo-600 w-24 h-24 rounded-full flex items-center justify-center mx-auto shadow-[8px_8px_0px_0px_rgba(15,23,42,1)]">
                 <CheckCircle2 className="w-12 h-12 text-white" />
               </div>
               <div>
                  <h3 className="text-3xl font-black text-slate-900 uppercase">{file.name}</h3>
               ...
               <button 
                  ...
                  className="bg-slate-900 text-white font-black px-6 py-3 rounded-2xl hover:bg-red-600 transition-all uppercase tracking-widest text-[10px] flex items-center mx-auto"
               >
            ...
            <>
              ...
              <h3 className="text-4xl font-black text-slate-900 uppercase mb-4 italic">Materialize Data Stream</h3>
              <p className="text-slate-500 font-bold max-w-sm uppercase text-xs tracking-widest leading-loose">
                ...
                <button 
                   ...
                   className="text-indigo-600 underline decoration-4 underline-offset-4 mx-2"
                >
                  manually select 
                </button> 
        ...
        <div className="space-y-8 h-full">
           <div className="bg-slate-900 rounded-[3rem] p-10 text-white min-h-[400px] flex flex-col justify-between shadow-[24px_24px_0px_0px_rgba(79,70,229,0.2)]">
              <div>
                ...
                {errorStatus && (
                  <div className="mt-8 bg-red-600/20 border-4 border-red-600 p-6 rounded-2xl flex items-start animate-in shake duration-500">
              ...
              <button 
                ...
                className={`w-full mt-10 py-6 rounded-[2rem] font-black uppercase tracking-[0.3em] flex items-center justify-center transition-all shadow-[12px_12px_12px_rgba(0,0,0,0.5)] active:translate-y-2 active:shadow-none ${
                   ...
                   ? 'bg-yellow-400 text-slate-900 border-4 border-slate-900 hover:scale-[1.02]' 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-10">
         {[
           ...
           <div key={i} className="bg-white border-4 border-slate-900 p-6 rounded-3xl shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] hover:bg-indigo-50 transition-colors">
              <h5 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 italic">AXIOM_PROTOCOL_0{i+1}</h5>
              <h4 className="text-xl font-black text-slate-900 uppercase mb-2">{box.title}</h4>
