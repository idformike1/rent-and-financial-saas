      ...
      <div className="pt-2 pb-6 space-y-8 bg-[#161821]">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
               <div className="h-8 w-64 bg-white/[0.03] rounded-full" />
               <div className="h-8 w-20 bg-white/[0.03] rounded-full" />
            </div>
        </div>
         ...
         {[...Array(15)].map((_, i) => (
           ...
           >
             ...
             <div className="flex items-center gap-4">
                <div className="w-7 h-7 rounded-full bg-white/[0.03] shrink-0" />
