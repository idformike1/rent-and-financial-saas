               ...
               {!tenant.isDeleted && (
                 <div className="flex flex-col gap-2">
                    <button 
                      ...
                      className="bg-[var(--primary)] text-white font-black px-12 py-5 rounded-3xl shadow-[0_20px_40px_rgba(255,87,51,0.2)] hover:bg-[var(--primary)] active:scale-95 transition-all flex items-center uppercase italic tracking-widest text-[11px] h-20 min-w-[300px] justify-center disabled:opacity-50 font-mono"
                    >
                    ...
                    <button 
                      ...
                      className="bg-white/3 text-white border border-white/10 px-8 py-4 rounded-xl hover:bg-white/5 transition-all flex items-center justify-center gap-3 uppercase font-black tracking-widest text-[9px] font-mono h-14"
                    >
        ...
        <div className="md:col-span-4 space-y-8">
           ...
           <div className="bg-slate-950 border border-white/10 rounded-[3rem] p-10">
              <div className="flex justify-between items-center mb-10">
                 ...
                 {!tenant.isDeleted && (
                    <button onClick={() => setIsAddLeaseModalOpen(true)} className="bg-white/3 text-white p-3 rounded-3xl hover:bg-white/5 transition-all border border-white/10 shadow-lg">
              ...
              <div className="space-y-6">
                 {activeLeases.length === 0 ? (
                    <div className="py-12 text-center bg-card/[0.02] rounded-[2rem] border border-dashed border-white/10">
                 ...
                 <div className="space-y-8">
                   ...
                   <div className="grid grid-cols-2 gap-8">
                     <div>
                       ...
                       <input {...register('email')} className="w-full bg-slate-950 border border-white/5 rounded-3xl p-6 text-sm font-bold outline-none focus:border-brand transition-all text-white" />
                     </div>
                     <div>
                       <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] block mb-4 ml-6">Telephonic Line</label>
                       <input {...register('phone')} className="w-full bg-slate-950 border border-white/5 rounded-3xl p-6 text-sm font-bold outline-none focus:border-brand transition-all text-white" />
                     </div>
                   </div>
                   <div>
                     ...
                     <input {...register('nationalId')} className="w-full bg-slate-950 border border-white/5 rounded-3xl p-8 text-xl font-black outline-none focus:border-brand transition-all text-white uppercase tracking-widest font-mono" />
                   </div>
                 </div>
              ...
              <form onSubmit={handleLeaseSubmit(onAddLease)} className="p-16 space-y-10">
                 ...
                 <div className="grid grid-cols-2 gap-8">
                    <div>
                      ...
                      <input type="number" {...regLease('rentAmount', {valueAsNumber: true})} className="w-full bg-slate-950 border border-white/5 rounded-3xl p-6 text-sm font-bold text-white outline-none focus:border-brand transition-all" />
                    </div>
                    <div>
                      <label className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] block mb-4 ml-6">Collateral ($)</label>
                      <input type="number" {...regLease('depositAmount', {valueAsNumber: true})} className="w-full bg-slate-950 border border-white/5 rounded-3xl p-6 text-sm font-bold text-white outline-none focus:border-brand transition-all" />
                    </div>
                 </div>
                 <button disabled={isSubmitting} className="w-full h-24 bg-brand text-white font-black rounded-3xl shadow-[0_30px_60px_rgba(var(--brand-rgb),0.2)] hover:scale-[1.02] active:scale-98 disabled:opacity-50 transition-all uppercase tracking-[0.3em] text-[12px]">
            ...
            <div className="bg-slate-900 rounded-[4rem] shadow-2xl w-full max-w-lg overflow-hidden border border-white/5 relative">
               <div className="p-16 text-center">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <button onClick={() => setIsMoveOutModalOpen(null)} className="w-full text-slate-400 font-black uppercase tracking-[0.5em] text-[8px] py-8 hover:text-white transition-colors">
                      Maintain Assignment
                    </button>
                  </div>
               </div>
