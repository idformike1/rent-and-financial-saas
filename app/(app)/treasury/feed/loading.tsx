  ...
  return (
    <div className="space-y-0 bg-background min-h-screen font-sans animate-pulse">
      ...
      <div className="pt-2 pb-6 space-y-8 bg-background">
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
               <div className="h-8 w-64 bg-white/[0.03] rounded-[6px]" />
               <div className="h-8 w-20 bg-white/[0.03] rounded-[6px]" />
            </div>
        </div>
      ...
      <div className="py-5 flex items-center justify-between bg-background border-b border-white/[0.05]">
          <div className="flex items-center gap-3">
             <div className="h-8 w-32 bg-white/[0.03] rounded-[6px]" />
             <div className="h-8 w-24 bg-white/[0.03] rounded-[6px]" />
          </div>
         ...
         {[...Array(15)].map((_, i) => (
           ...
           >
             ...
             <div className="flex items-center gap-4">
                <div className="w-7 h-7 rounded-[6px] bg-white/[0.03] shrink-0" />
