...
export default async function ExpenseLoggingPage() {
  ...
  return (
    <div className="py-12 px-6 max-w-5xl mx-auto space-y-16">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-border dark:border-white/5 pb-10 gap-8">
      ...
      <div className="bg-card/40 dark:bg-slate-900/40 backdrop-blur-xl border border-border dark:border-white/5 rounded-[3rem] p-12 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-premium">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          <Link
            href="/expenses"
            className="h-14 px-8 bg-card dark:bg-slate-800 border border-border dark:border-white/5 text-[10px] font-black rounded-3xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-all uppercase tracking-widest italic flex items-center justify-center"
          >
