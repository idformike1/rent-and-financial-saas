...
export default function SummaryCard({ entries, title = "Summary" }: SummaryCardProps) {
  ...
  return (
    <div className="bg-card border border-white/[0.05] rounded-[var(--radius-sm)] p-6 flex flex-col gap-8  relative overflow-hidden">
      {/* Glossy Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-white/[0.02] to-transparent pointer-events-none"></div>

      <h3 className="text-[14px] font-normal text-clinical-muted tracking-clinical relative z-10">{title}</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12 relative z-10">
        ...
        <div className="flex flex-col gap-2 border-b border-white/5 pb-4 md:border-b-0 md:pb-0">
          <span className="text-[13px] text-clinical-muted font-normal tracking-clinical">Transactions</span>
        ...
        <div className="flex flex-col gap-2 border-b border-white/5 pb-4 md:border-b-0 md:pb-0">
          <span className="text-[13px] text-clinical-muted font-normal tracking-clinical">Accounts used</span>
          <span className="text-[28px] text-white font-normal font-finance leading-none">
        ...
        <div className="flex flex-col gap-2 col-span-1 md:col-span-2 mt-2">
          <span className="text-[13px] text-clinical-muted font-normal tracking-clinical">Fees paid</span>
          <span className="text-[28px] text-white font-normal font-finance leading-none">
