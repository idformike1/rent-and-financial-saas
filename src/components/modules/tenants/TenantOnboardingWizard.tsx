...
const onboardingSchema = z.object({
  ...
  phone: z.string().min(8, "Valid phone required").regex(/^[0-9+\-\s()]+$/, "Invalid phone format"),
  nationalId: z.string().min(4, "Legal identifier required"),
  unitId: z.string().min(1, "Select a unit"),
  baseRent: z.coerce.number().positive("Rent must be positive"),
...
export default function TenantOnboardingWizard({ initialUnits }: TenantOnboardingWizardProps) {
  const router = useRouter();
  const [currentStep, setCurrentStep] = useState(1);
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [serverError, setServerError] = useState('');
  const [successData, setSuccessData] = useState<any>(null);
  const [units] = useState<any[]>(initialUnits);
  ...
  const handleNext = async () => {
    ...
    if (currentStep === 1) {
      ...
      try {
        ...
        if (check.exists) {
          const errorMsg = "Identity conflict detected. Please resolve highlighted fields.";
  ...
  const onSubmit: SubmitHandler<OnboardingFormData> = async (data) => {
    ...
    try {
      ...
      const errorMsg = err.message || "Network protocol failure";
      setServerError(errorMsg);
      toast.error(errorMsg);
    } finally {
    ...
    <div className="min-h-screen bg-background text-slate-300 flex flex-col items-center pt-12 pb-24 px-4 font-sans selection:bg-brand/30">
      ...
      <div className="w-full max-w-4xl bg-card border border-slate-800 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in slide-in-from-right-4 duration-500">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className={cn(
                    "w-full bg-muted border rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand transition-all",
                    errors.tenantName ? "border-rose-500/50 ring-1 ring-rose-500/20" : "border-slate-700"
                  )}
                />
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className={cn(
                    "w-full bg-muted border rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand transition-all",
                    errors.email ? "border-rose-500/50 ring-1 ring-rose-500/20" : "border-slate-700"
                  )}
                />
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className={cn(
                    "w-full bg-muted border rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand transition-all",
                    errors.phone ? "border-rose-500/50 ring-1 ring-rose-500/20" : "border-slate-700"
                  )}
                />
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={cn(
                      "w-full bg-muted border rounded-lg pl-11 pr-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-brand transition-all",
                      errors.nationalId ? "border-rose-500/50 ring-1 ring-rose-500/20" : "border-slate-700"
                    )}
                  />
                </div>
              ...
              <div className="col-span-1 md:col-span-2 space-y-2">
                ...
                <div className="relative">
                  ...
                  <select 
                    {...register('unitId')}
                    className={cn(
                      "w-full bg-muted border rounded-lg pl-11 pr-4 py-3 text-white appearance-none focus:outline-none focus:border-brand transition-all cursor-pointer",
                      errors.unitId ? "border-rose-500/50 ring-1 ring-rose-500/20" : "border-slate-700"
                    )}
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={cn(
                      "w-full bg-muted border rounded-lg pl-11 pr-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-brand transition-all",
                      errors.baseRent ? "border-rose-500/50 ring-1 ring-rose-500/20" : "border-slate-700"
                    )}
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={cn(
                      "w-full bg-muted border rounded-lg pl-11 pr-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-brand transition-all",
                      errors.securityDeposit ? "border-rose-500/50 ring-1 ring-rose-500/20" : "border-slate-700"
                    )}
                  />
                </div>
          ...
          {serverError && (
            <div className="mt-8 p-4 bg-rose-500/5 border border-rose-500/10 rounded-xl flex items-center gap-4 text-rose-500 animate-in fade-in slide-in-from-top-2 duration-300">
