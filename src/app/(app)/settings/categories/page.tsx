  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <Card className="glass-panel border border-[var(--border)] rounded-[var(--radius-sm)] p-6 flex flex-col md:flex-row items-center gap-6 relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--primary)]/5 rounded-[var(--radius-sm)] -mr-32 -mt-32 transition-transform duration-700 group-hover:scale-110" />
          <div className="w-20 h-20 rounded-[var(--radius-sm)] bg-[var(--primary-muted)] flex items-center justify-center shrink-0 border border-[var(--border)] relative z-10">
