...
export default function OntologyMapPage() {
  ...
  if (!tree) return (
    <div className="min-h-screen bg-[var(--background)] p-6 lg:p-6 overflow-x-auto border-none">
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] p-6 lg:p-6 overflow-x-auto selection:bg-[var(--primary-muted)] border-none scrollbar-hide text-[var(--foreground)]">
...
function TreeNode({ node, isRoot = false }: { node: any, isRoot?: boolean }) {
  ...
  if (node.type === 'EMPTY_STATE') {
      return (
        <div className="min-w-[280px] p-5 bg-[var(--background)] border border-dashed border-[var(--border)] text-[10px] text-[var(--muted)] text-center  rounded-[8px]">
          {node.name}
        </div>
      )
  }
           ...
           <div className="space-y-2">
              ...
              {node.amount && (
                 <div className="flex items-center justify-between">
                    ...
                    <span className="text-[var(--primary)] text-[11px] font-finance tabular-nums font-bold">
              ...
              {node.transactionDate && (
                 <div className="flex items-center justify-between opacity-40 text-[7px]">
