...
import { Card, Badge, Button, cn, MercuryTable, THead, TBody, TR, TD, Input } from '@/components/ui-finova'
      ...
      <div className="mercury-card w-full overflow-hidden">
        ...
        <div className="p-4 border-b border-white/[0.08] flex items-center justify-between gap-4 bg-white/[0.02]">
           <div className="flex items-center gap-2 flex-1">
               <span className="text-[10px] text-muted-foreground/30 font-bold">[S]</span>
              <Input 
                type="text" 
                value={searchTerm}
        ...
        {filteredTenants.length === 0 ? (
          <div className="p-12 text-center space-y-4">
             ...
             <Button type="button" variant="secondary" size="sm" onClick={() => setSearchTerm('')} disabled={!searchTerm}>Reset Scan</Button>
          </div>
        ) : (
            ...
            <MercuryTable>
              <THead>
                <TR isHeader>
                  ...
                  <TD isHeader className="w-[60px]">{null}</TD>
                </TR>
              </THead>
              <TBody>
