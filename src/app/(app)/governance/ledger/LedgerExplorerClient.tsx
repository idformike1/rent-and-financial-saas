    ...
    <div className="min-h-screen bg-background text-foreground p-8 pt-6 space-y-8">
      ...
      <div className="flex items-end justify-between">
        ...
        <div className="flex items-center gap-4">
           ...
           <Button type="button" className="bg-white text-black hover:bg-white/90 uppercase tracking-widest text-[10px] font-bold h-10 px-6" disabled={filteredData.length === 0}>
             Export Report
           </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4 items-center bg-white/[0.02] border border-white/5 rounded-[12px] p-4">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center h-10 bg-white/[0.03] border border-white/5 rounded-md p-1">
             <Button 
                type="button"
                variant="ghost"
                disabled={false}
          ...
          {/* DATE RANGE */}
          <div className="h-10 border border-white/5 bg-white/[0.01] rounded-md overflow-hidden flex items-center px-1">
             <InsightsDatePicker 
                date={dateRange} 
                setDate={(range) => {
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative group w-[300px]">
            ...
            <input 
               ...
               className="w-full h-10 bg-white/[0.03] border border-white/5 rounded-md pl-10 pr-4 text-sm outline-none focus:border-primary/20 focus:bg-white/[0.05] transition-all"
            />
            {searchInput && (
      ...
      <div className="space-y-1">
        ...
        {filteredData.length === 0 && (
           <div className="h-64 flex flex-col items-center justify-center text-white/20 gap-4 border border-dashed border-white/5 rounded-xl mt-4">
              <Database size={32} />
