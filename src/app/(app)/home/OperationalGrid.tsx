    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
      ...
      <div className="mercury-card h-[280px]">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-1 text-white/30">
            <Button type="button" variant="ghost" disabled={false} className="p-1 h-7 w-7 hover:bg-white/5 rounded-[6px] bg-transparent border-none transition-colors"><ChevronLeft className="w-3.5 h-3.5" /></Button>
            <span className="text-[12px] font-[400] font-sans">1/9</span>
            <Button type="button" variant="ghost" disabled={false} className="p-1 h-7 w-7 hover:bg-white/5 rounded-[6px] bg-transparent border-none transition-colors"><ChevronRight className="w-3.5 h-3.5" /></Button>
          </div>
        </div>
      ...
      <div className="mercury-card h-[280px]">
        ...
        <div className="flex justify-between items-center mt-4 pt-4 border-t border-border">
          ...
          <Button type="button" variant="secondary" disabled={false} className="px-3 py-1 h-7 bg-muted rounded-[6px] text-[11px] font-[400] text-foreground hover:bg-white/10 transition-colors tracking-tight border-none">
            Manage
          </Button>
        </div>
      </div>
      ...
      <div className="mercury-card h-[280px]">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 text-white/30">
            <Button type="button" variant="ghost" disabled={false} className="p-1 h-7 w-7 hover:bg-white/5 bg-transparent border-none rounded-[6px] transition-colors"><Upload className="w-3.5 h-3.5" /></Button>
            <Button type="button" variant="ghost" disabled={false} className="p-1 h-7 w-7 hover:bg-white/5 bg-transparent border-none rounded-[6px] transition-colors"><MoreHorizontal className="w-3.5 h-3.5" /></Button>
          </div>
        </div>
      ...
      <div className="mercury-card h-[280px]">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-1 text-white/30">
            <Button type="button" variant="ghost" disabled={false} className="p-1 h-7 w-7 bg-transparent hover:bg-white/5 rounded-[6px] border-none transition-colors"><Plus className="w-3.5 h-3.5" /></Button>
            <Button type="button" variant="ghost" disabled={false} className="p-1 h-7 w-7 bg-transparent hover:bg-white/5 rounded-[6px] border-none transition-colors"><MoreHorizontal className="w-3.5 h-3.5" /></Button>
          </div>
        </div>
