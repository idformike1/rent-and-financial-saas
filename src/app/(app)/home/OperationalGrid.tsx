...
export default function OperationalGrid() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-1 text-white/30">
            <Button 
              ...
              className="p-1 h-7 w-7 hover:bg-white/5 rounded-[var(--radius-sm)] bg-transparent border-none transition-colors"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="h-1.5 w-full bg-muted rounded-[var(--radius-sm)] overflow-hidden">
              <div className="h-full bg-mercury-green rounded-[var(--radius-sm)]" style={{ width: '65%' }} />
            </div>
      ...
      <div className="mercury-card h-[280px]">
        <div className="flex justify-between items-center">
          <h3 className="text-[15px] font-[400] text-white tracking-clinical font-sans">Occupancy yield</h3>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="h-2 w-full bg-muted rounded-[var(--radius-sm)] overflow-hidden flex">
        ...
        <div className="flex justify-between items-center mt-4 pt-4 border-t border-border">
          ...
          <Link href="/onboarding">
            <Button type="button" variant="secondary" disabled={false} className="px-3 py-1 h-7 bg-muted rounded-[var(--radius-sm)] text-mercury-label-caps text-foreground hover:bg-white/10 transition-colors border-none">
              Manage
            </Button>
          </Link>
        </div>
      ...
      <div className="mercury-card h-[280px]">
        <div className="flex justify-between items-center">
          <h3 className="text-mercury-heading text-white">Expense payables</h3>
          <div className="flex items-center gap-2 text-white/30">
            <Button 
              type="button" 
              variant="ghost" 
              onClick={() => handleActionClick('Document Upload')}
              className="p-1 h-7 w-7 hover:bg-white/5 bg-transparent border-none rounded-[var(--radius-sm)] transition-colors"
            >
        ...
        <div className="flex justify-between items-center mt-auto pt-4 border-t border-border">
          <span className="text-mercury-body text-foreground/80">Inbox: 3 items - $10K</span>
      ...
      <div className="mercury-card h-[280px]">
        <div className="flex justify-between items-center">
          <h3 className="text-mercury-heading text-white">Rent receivables</h3>
          <div className="flex items-center gap-1 text-white/30">
            <Button 
              type="button" 
              variant="ghost" 
              onClick={() => handleActionClick('Quick Provisioning')}
              className="p-1 h-7 w-7 bg-transparent hover:bg-white/5 rounded-[var(--radius-sm)] border-none transition-colors"
            >
        ...
        <div className="flex justify-between items-center mt-auto pt-4 border-t border-border">
          <span className="text-mercury-body text-foreground/80">Open: 12 items - $12.3K</span>
          <Link href="/reports">
            <Button type="button" variant="ghost" disabled={false} className="h-auto p-0 text-mercury-body text-clinical-muted hover:text-foreground transition-colors flex items-center gap-1 bg-transparent border-none">
              View <ArrowRight className="w-3 h-3" />
            </Button>
