    ...
    <div className="space-y-6 pb-24 max-w-7xl mx-auto animate-in fade-in duration-500">
      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-[var(--border)] pb-10">
        <div className="space-y-4">
          <Badge variant="brand" className="px-5 py-2 rounded-[var(--radius-sm)]  text-[9px] bg-[var(--primary-muted)] border-2 border-[var(--primary)]/20">
            Team Command Center
          </Badge>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {statCards.map((s) => (
          <div key={s.label} className="glass-panel rounded-[var(--radius-sm)] p-6 flex flex-col justify-between gap-4 border border-[var(--border)] hover:border-[var(--primary)]/30 transition-all">
      ...
      <footer className="text-[9px] text-[var(--muted)]   text-center pt-4 border-t border-[var(--border)]">
