    ...
    <div className="h-[400px] w-full bg-card p-6 border border-border rounded-[8px] overflow-hidden">
      <div className="flex items-center justify-between mb-8 pb-4 border-b border-border">
        ...
        <div className="flex gap-4">
             <div className="flex items-center gap-1.5"><div className="w-2 h-2 bg-mercury-green rounded-[6px]" /> <span className="text-[9px] font-bold text-muted-foreground uppercase">Growth Revenue</span></div>
             <div className="flex items-center gap-1.5"><div className="w-2 h-2 bg-destructive rounded-[6px]" /> <span className="text-[9px] font-bold text-muted-foreground uppercase">Operational Loss</span></div>
        </div>
      </div>
