  ...
  return (
    <div className="flex gap-4">
      <button 
        ...
        className="bg-brand text-foreground font-black px-6 py-3 rounded-3xl shadow-lg shadow-brand/20 hover:-translate-y-1 transition-transform flex items-center uppercase tracking-widest text-[10px]"
      >
